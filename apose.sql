...
CREATE TABLE IF NOT EXISTS epreuve (
  cod_epr varchar(10) NOT NULL,
  lib_epr varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS epr_sanctionne_elp (
  cod_elp varchar(8) NOT NULL,
  cod_epr varchar(10) NOT NULL,
  cod_ses varchar(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS table_elp (
  ...
  lib_elp_lng varchar(500) NOT NULL DEFAULT '',
